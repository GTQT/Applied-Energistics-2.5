...
public final class AEConfig extends Configuration implements IConfigurableObject, IConfigManagerHost {
    ...
    private String[] nonBlockingItems = { "[gregtech|actuallyadditions]", "gregtech:circuit.integrated",
            ...
            "gregtech:shape.mold.rotor", "gregtech:shape.mold.rod", "gregtech:shape.mold.bolt",
            "gregtech:shape.mold.round", "gregtech:shape.mold.screw", "gregtech:shape.mold.ring",
            "gregtech:shape.mold.rod_long", "gregtech:shape.mold.turbine_blade", "gregtech:shape.mold.drill_head",
            "gregtech:shape.mold.pipe.tiny", "gregtech:shape.mold.pipe.small", "gregtech:shape.mold.pipe.normal",
            "gregtech:shape.mold.pipe.large", "gregtech:shape.mold.pipe.huge", "gregtech:shape.extruder.plate",
            "gregtech:shape.extruder.rod", "gregtech:shape.extruder.bolt", "gregtech:shape.extruder.ring",
            "gregtech:shape.extruder.cell", "gregtech:shape.extruder.ingot", "gregtech:shape.extruder.wire",
            "gregtech:shape.extruder.pipe.tiny", "gregtech:shape.extruder.pipe.small",
            "gregtech:shape.extruder.pipe.normal",
            "gregtech:shape.extruder.pipe.large", "gregtech:shape.extruder.pipe.huge", "gregtech:shape.extruder.block",
            "gregtech:shape.extruder.gear", "gregtech:shape.extruder.bottle", "gregtech:shape.extruder.foil",
            "gregtech:shape.extruder.gear_small", "gregtech:shape.extruder.rod_long", "gregtech:shape.extruder.rotor",
            "gregtech:shape.extruder.turbine_blade", "gregtech:shape.extruder.drill_head",
            "gregtech:shape.mold.vanadium_steel.saw",
            "gregtech:shape.mold.vanadium_steel.hard_hammer", "gregtech:shape.mold.vanadium_steel.soft_mallet",
            "gregtech:shape.mold.vanadium_steel.wrench", "gregtech:shape.mold.vanadium_steel.file",
            "gregtech:shape.mold.vanadium_steel.crowbar", "gregtech:shape.mold.vanadium_steel.screwdriver",
            "gregtech:shape.mold.vanadium_steel.mortar", "gregtech:shape.mold.vanadium_steel.wire_cutter",
            "gregtech:shape.mold.vanadium_steel.knife", "gregtech:shape.mold.vanadium_steel.butchery_knife",
            "gregtech:shape.mold.vanadium_steel.rolling_pin", "ore:lensAlmandine", "ore:lensBlueTopaz",
            "ore:lensDiamond", "ore:lensEmerald", "ore:lensGreenSapphire", "ore:lensRutile", "ore:lensRuby",
            "ore:lensSapphire", "ore:lensTopaz", "ore:lensJasper", "ore:lensGlass", "ore:lensOlivine",
            "ore:lensOpal", "ore:lensAmethyst", "ore:lensLapis", "ore:lensEnderPearl", "ore:lensEnderEye",
            "ore:lensGarnetRed", "ore:lensGarnetYellow", "ore:lensVinteum", "ore:lensNetherStar", };
